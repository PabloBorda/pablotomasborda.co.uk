...
function setaddr(){
 window.globaldata.order.addr = str;
...
function validate_address(){
     ...
     var checkaddr_content = "<label>The GPS is not always accurate, </label></br>" +
                              "<label>Select one of the following addresses: </br>" +
                               selectaddr + "</br> Or even better, input your address" + 
			       " in the following autocomplete field </br>" + 
